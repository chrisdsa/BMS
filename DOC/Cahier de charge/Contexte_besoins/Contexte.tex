\section{Contexte et définition du problème}
	...
	La protection et la gestion de batteries se fait par un système électronique. Il est important de comprendre les différentes composantes formant le système de protection et de gestion de batterie.
		...
		\subsection{Danger des batteries Li-Ion}
		% merder avec la version à l'école
		...
		L'équipe s'est fait donner comme contrainte que le système de protection de gestion de batterie soit compatible avec le système actuel. Puisque développement d'un tel système est long et complexe, le directeur électrique du club veut pouvoir remplacer le système par l'ancien si un problème survient durant la compétition.
		
		\paragraph{}
		Certaines composantes doivent donc ressembler au système provenant de la compagnie Lithium Balance. 
		
	
		\begin{figure}[h!]
			\centering
			\includegraphics[scale=0.5]{./Contexte_besoins/Hardware.jpg}
		...
		\paragraph{}	
		Les connections entre les modules et le système doivent avec le même brochage pour être facilement remplacer sans modifications majeurs. 
			
		
		\begin{figure}[h!]
			\centering
			\includegraphics[scale=1]{./Contexte_besoins/Pinout.jpg}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[scale=1]{./Contexte_besoins/Pinout2.jpg}
			\caption{Brochage du connecteur}
			\label{fig:Brochage2}
		\end{figure}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[scale=1]{./Contexte_besoins/Pinoutslave.jpg}
			\caption{Brochage du connecteur}
			\label{fig:Brochage3}
		\end{figure}
