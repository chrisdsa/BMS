\section{Compatibilité avec le BMS présentement utilisé}
	\paragraph*{}	
	Afin que le système soit rétro-compatible avec le BMS de Lithium Balance, il est nécessaire que le connecteur 22 broches qui relient le module maître avec le reste des modules externes, soit interchangeable entre l'ancien et le nouveau BMS.

	\subsection{Brochage du connecteurs 22 pattes de Lithium Balance}
	
	 Selon le manuel d'utilisation de Lithium Balance, le brochage du connecteurs 22 est détaillée au tableau \ref{22CLithiumBalance} \cite{Lithium_Balance}. 
