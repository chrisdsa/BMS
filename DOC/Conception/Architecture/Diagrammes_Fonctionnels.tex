\section{Annexes: Diagrammes fonctionnels}
	...
	\subsection{Module maître}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_MiseEnMarche}}
	...
	\subsection{Module esclave}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_SlaveMiseEnMarche}}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_SlaveLectureDeTension}}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_SlaveBalancement}}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_SlaveLectureTemperature}}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_SlaveCan}}
	...
	\subsection{Module de lecture de courant}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_CurrentMiseEnMarche}}
		...
		\begin{figure}[H]
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/DiagrammeFonctionnel_CurrentCan}}
